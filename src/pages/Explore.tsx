                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredSessions.map((session) => (
                        <div 
                            ...
                            className="group relative bg-card hover:bg-muted/10 border border-border/60 rounded-[2.5rem] p-8 transition-all hover:shadow-2xl hover:border-primary/20 flex flex-col min-h-[320px] cursor-pointer"
                        >
                            ...
                            <div className="flex-1">
                                <h3 className="font-bold text-2xl mb-2 group-hover:text-primary transition-colors line-clamp-1">
                                    {session.name}
                                </h3>
                                ...
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary font-bold text-[10px] border border-primary/10 shadow-inner">
